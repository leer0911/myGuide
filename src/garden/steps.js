...
import * as introJsPropTypes from './util/proptypes';
import * as introJsDefaultProps from './util/defaultProps';
...
export default class Steps extends Component {
  ...
  updateStepElement = stepIndex => {
    const element = document.querySelector(
      this.introJs._options.steps[stepIndex].element
    );

    if (element) {
      this.introJs._introItems[stepIndex].element = element;
      this.introJs._introItems[stepIndex].position =
        this.introJs._options.steps[stepIndex].position || 'auto';
    }
  };
